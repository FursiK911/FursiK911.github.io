...
- 341 files · ~88,604 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary

- 1034 nodes · 1552 edges · 130 communities (91 shown, 39 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness

- Built from commit: `7847b25e`
...
7. `scripts` - 14 edges
8. `useLoadingSequence()` - 14 edges
9. `installIntersectionObserverMock()` - 13 edges
...
### Community 3 - "Seamless Hero portrait handoff"
...
### Community 21 - "Dmitry Fursov — Software Developer"
...
### Community 28 - "work-experience/index.ts"

Cohesion: 0.47
Nodes (5): workExperience, ExperienceProject, ExperienceRolePhase, WorkExperience, createExperienceProject()

### Community 29 - "useKonamiCode.ts"

Cohesion: 0.39
Nodes (3): KONAMI_CODE, useKonamiCode(), KonamiDebug()

### Community 31 - "ExperienceTimeline.cancels-a-pending-refresh-when-the-timeline-unmounts.test.tsx"

Cohesion: 0.22
Nodes (4): animationFrames, { gsapSet, gsapTo, runnerTweens }, resizeDisconnect, resizeObserve

### Community 32 - "ExperienceTimeline.keeps-the-runner-static-when-reduced-motion-is-requested.test.tsx"

Cohesion: 0.22
Nodes (4): animationFrames, { gsapSet, gsapTo, runnerTweens }, resizeDisconnect, resizeObserve

### Community 33 - "ExperienceTimeline.rebuilds-the-runner-after-a-desktop-resize-and-preserves-its-progress.test.tsx"

Cohesion: 0.22
Nodes (4): animationFrames, { gsapSet, gsapTo, runnerTweens }, resizeDisconnect, resizeObserve

### Community 34 - "ExperienceTimeline.stops-on-mobile-and-restarts-from-the-beginning-on-desktop.test.tsx"

Cohesion: 0.22
Nodes (4): animationFrames, { gsapSet, gsapTo, runnerTweens }, resizeDisconnect, resizeObserve

### Community 35 - "2026-08-25"
...
### Community 37 - "Agent Operating Rules"
...
### Community 40 - "ExperienceTimeline.localizes-short-timeline-roles-and-the-future-cta-in-russian.test.tsx"

Cohesion: 0.25
Nodes (4): animationFrames, { gsapSet, gsapTo, runnerTweens }, resizeDisconnect, resizeObserve

### Community 41 - "ExperienceTimeline.renders-the-complete-career-path-and-future-milestone.test.tsx"

Cohesion: 0.25
Nodes (4): animationFrames, { gsapSet, gsapTo, runnerTweens }, resizeDisconnect, resizeObserve

### Community 42 - "ExperienceTimelineItem.tsx"

Cohesion: 0.43
Nodes (3): ExperienceTimelineItem(), ExperienceTimelineItemProps, getCompanyInitials()

### Community 44 - "TestProviders.tsx"
...
### Community 55 - "AI Agent Change Log Index"

Cohesion: 0.50
Nodes (4): AI Agent Change Log Index, Browse by decision, Browse by period, Latest entries

### Community 61 - "Centered cyan education timeline"

Cohesion: 0.67
Nodes (3): 2026-09-02 15:54 +03:00, Centered cyan education timeline, Decision DEC-20260902-07

### Community 62 - "LiveCam.tsx"

Cohesion: 0.11
Nodes (23): liveCamConfig, liveCamStatusClassNames, liveCamHudConfig, initialLiveCamTelemetry, initialLiveCamTracker, initialLiveCamWaveform, liveCamHudEvents, LiveCam() (+15 more)
...
### Community 65 - "Education timeline centered-axis layout"

Cohesion: 0.67
Nodes (3): 2026-09-02 16:07 +03:00, Decision DEC-20260902-08, Education timeline centered-axis layout

### Community 66 - "Fixed Mantine centered Education Timeline axis"
...
- **355 isolated node(s):** `name`, `private`, `version`, `type`, `node` (+350 more)
