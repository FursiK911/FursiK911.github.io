...
7. `scripts` - 14 edges
8. `changeLanguage()` - 9 edges
9. `2026-08-29` - 8 edges
10. `Project` - 8 edges
...
Cohesion: 0.11
Nodes (18): App(), sectionIds, renderReadyApp(), Footer(), SectionHeading(), SectionHeadingProps, Projects(), About() (+10 more)
...
### Community 4 - "ExperienceTimeline.tsx"

Cohesion: 0.14
Nodes (17): ExperienceDetails(), ExperienceDetailsProps, ExperienceDetailsItem(), ExperienceDetailsItemProps, ExperienceTimeline(), ExperienceTimelineProps, fallbackPoints, pointToSceneAtX() (+9 more)
...
Cohesion: 0.15
Nodes (13): Hero(), heroItemVariants, HeroProps, Header(), HeaderProps, sectionIds, TypingText(), TypingTextProps (+5 more)
...
Cohesion: 0.27
Nodes (10): GlitchPortrait(), GlitchPortraitProps, { glitchMock, GlitchMock }, props, burstDuration(), createGlitch(), markDecorativeLayers(), nextPause() (+2 more)

### Community 13 - "2026-08-29"
...
### Community 14 - "KonamiDebug.tsx"

Cohesion: 0.52
Nodes (3): KonamiDebug(), KONAMI_CODE, useKonamiCode()

### Community 15 - "AI Agent Change Log Index"
...
### Community 18 - "Quality Validation"

Cohesion: 0.67
Nodes (3): Quality Gate, Quality Validation, Validate Job

### Community 19 - "Build Job"
...
- **187 isolated node(s):** `sectionIds`, `LoadingAnimationDebugProps`, `SectionHeadingProps`, `TypingTextProps`, `listeners` (+182 more)
...
- **Why does `renderWithProviders()` connect `App.tsx` to `loadingAnimation.ts`, `ExperienceTimeline.tsx`, `data/portfolio.ts`, `i18n.ts`, `usePortraitGlitch.ts`, `KonamiDebug.tsx`?**
