/* c8 ignore file -- registry-sourced WebGL implementation is integration-tested through its adapter. */
...
import styles from './styles/GridScan.module.css'
import type { GridScanProps } from './types/GridScan.types'
      ...
      {showPreview && (
        <div className={styles.gridscanPreview}>
          <video
            ...
            playsInline
            autoPlay
            className={styles.gridscanVideo}
          />
