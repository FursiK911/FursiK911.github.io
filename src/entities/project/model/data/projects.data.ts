...
const projectDefinitions: Array<Omit<Project, 'card'>> = [
  ...
  },
  {
    ...
    media: [
      ...
      {
        kind: 'image',
        src: projectMedia.mobileRts.gameplay,
        altKey: 'mobileRtsMediaGameplay',
      },
      {
        kind: 'image',
        src: projectMedia.mobileRts.mountainTournament,
        altKey: 'mobileRtsMediaMountainTournament',
      },
      {
        kind: 'image',
        src: projectMedia.mobileRts.historyMode,
        altKey: 'mobileRtsMediaHistoryMode',
      },
      {
        kind: 'image',
        src: projectMedia.mobileRts.arcanePortal,
        altKey: 'mobileRtsMediaArcanePortal',
      },
      {
        kind: 'image',
        src: projectMedia.mobileRts.magicAcademy,
        altKey: 'mobileRtsMediaMagicAcademy',
      },
      {
        kind: 'image',
        src: projectMedia.mobileRts.volcanicMountains,
        altKey: 'mobileRtsMediaVolcanicMountains',
      },
    ],
    featured: true,
  },
